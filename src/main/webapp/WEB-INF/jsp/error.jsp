...
<body>
   <h2>Instruction Queue - Error when adding Instruction Messages to Instruction Queue</h2>
   <ul>
   ...
   <h3>Error when adding Instruction Messages to Instruction Queue = ${error}</h3>
</body>
</html>